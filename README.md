...
The example below creates a VM with a new volume:
    ...
    brooklyn.catalog:
      ...
      version: 0.6.0-20170913.1047 # BROOKLYN_BLOCKSTORE_VERSION
      brooklyn.libraries:
      - file://~/.m2/repository/io/brooklyn/blockstore/brooklyn-blockstore/0.6.0-20170913.1047/brooklyn-blockstore-0.6.0-20170913.1047.jar # BROOKLYN_BLOCKSTORE_VERSION
      item:
        services:
